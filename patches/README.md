...
Both were checked (BUILD_LOG.md Step 15) to apply cleanly, in this order, to upstream `82ef384`
("Release ontology-transformer 0.1.7") and reproduce the patched files exactly. The second patch
is a diff *on top of* the first — it won't apply to an unpatched checkout.
